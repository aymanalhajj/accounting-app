...
;
--------------------------------------------------------
--  DDL for View PURCHASES_RPT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE VIEW "PURCHASES_RPT" ("P_NAME", "INV_TYPE_AR", "INV_TYPE_EN", "INVOICE_DATE", "INVOICE_NO", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT") AS 
  SELECT
    P_NAME,
    INV_TYPE_AR,
    INV_TYPE_EN,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "SALES_RETURN_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
