...
;
--------------------------------------------------------
--  DDL for View PURCHASES_R
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE VIEW "PURCHASES_R" ("P_NAME", "INV_TYPE_AR", "INV_TYPE_EN", "INVOICE_DATE", "INVOICE_NO", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT") AS 
  SELECT
    P_NAME,
    INV_TYPE_AR,
    INV_TYPE_EN,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "SALES_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "SALES_PURCHASE_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "P_NAME", "P_TAX_NO", "P_INV_DATE", "P_INV_ID", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_ID", "QR_CODE", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
WHERE LIST_ID = 4 AND ITEM_NO = PAYMENT_TYPE) INV_TYPE_EN ,
    C.NAME_AR P_NAME,
    C.TAX_NO P_TAX_NO,
    PROVIDER_INV_DATE P_INV_DATE,
    PROVIDER_INV_ID P_INV_ID,
    U.USER_NAME U_NAME,
    PRE_TAX_TOTAL_AMOUNT PRE_TAX_AMOUNT,
    TOTAL_DISCOUNT TOTAL_DIS,
    POST_DISCOUNT_TOTAL_AMOUNT POST_DIS_AMOUNT,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "SALES_PUR_RETURN_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "P_NAME", "P_TAX_NO", "P_INV_DATE", "P_INV_ID", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_ID", "QR_CODE", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "SALES_RETURN_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
