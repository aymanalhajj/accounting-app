...
-- Schema: ACCOUNTING   Date: Sun Oct 13 05:30:21 AST 2024
--
BEGIN
  ORDS.DEFINE_MODULE(
...
'select INVOICE_ID,
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'invoices',
      p_pattern        => 'store_first_period_stock',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
...
BEGIN
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'invoices',
      p_pattern        => 'store_first_period_stocks',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
...
BEGIN
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'invoices',
      p_pattern        => 'store_stockin_orders',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
...
FROM
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'invoices',
      p_pattern        => 'store_stockout_order',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
...
BEGIN
  ...
  ORDS.DEFINE_TEMPLATE(
      p_module_name    => 'invoices',
      p_pattern        => 'store_stockout_orders',
      p_priority       => 0,
      p_etag_type      => 'HASH',
      p_etag_query     => NULL,
      p_comments       => NULL);
