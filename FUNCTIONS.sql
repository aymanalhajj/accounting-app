...
BEGIN
    IF P_REPORT_TYPE = 1 THEN
        ...
        LOOP
            ...
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
    ...
    ELSE
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE BRANCH_ID = REC.BRANCH_ID AND INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE BRANCH_ID = REC.BRANCH_ID AND  INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
...
BEGIN
    IF P_REPORT_TYPE = 1 THEN
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
    ...
    ELSE
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PURCHASE_INV WHERE USER_ID = REC.USER_ID AND INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
        ...
        LOOP
            ...
            V_SALES_SUMMARY_REC.CNT := REC.CNT;
            SELECT
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=1 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))CASH_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 1 AND PAYMENT_TYPE=2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))BANK_INV_SUM,
                (SELECT SUM(INVOICE_TOTAL_AMOUNT) FROM SALES_PUR_RETURN_INV WHERE USER_ID = REC.USER_ID AND  INVOICE_TYPE = 2 AND INVOICE_DATE>= TO_DATE(P_FROM_DATE,'DD-MM-YYYY') AND INVOICE_DATE<= TO_DATE(P_TO_DATE,'DD-MM-YYYY'))DEFERRED_INV_SUM
            INTO V_SALES_SUMMARY_REC.CASH_INV_SUM,
                V_SALES_SUMMARY_REC.BANK_INV_SUM,
                V_SALES_SUMMARY_REC.DEFERRED_INV_SUM
            FROM DUAL;
