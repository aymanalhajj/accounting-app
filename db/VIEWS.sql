...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ADMIN_COMPANY_R" ("COMPANY_ID", "NAME_AR", "NAME_EN", "TAX_NO", "FAX", "COMERCIAL_REC_NO", "TEL_NO", "MOBILE_NO", "SREET", "LOGO") AS 
  SELECT 
com.COMPANY_ID,
com.NAME_AR,
com.NAME_EN,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_RETURN_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
