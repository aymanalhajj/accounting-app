...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ADMIN_COMPANY_R" ("COMPANY_ID", "NAME_AR", "NAME_EN", "TAX_NO", "COMERCIAL_REC_NO", "TEL_NO", "MOBILE_NO", "SREET", "LOGO") AS 
  SELECT 
com.COMPANY_ID,
com.NAME_AR,
com.NAME_EN,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "C_TAX_NO", "STORE_DATE", "C_MOBILE_NO", "C_STREET", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_PURCHASE_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "P_NAME", "P_TAX_NO", "P_INV_DATE", "P_INV_ID", "STORE_DATE", "P_MOBILE_NO", "P_STREET", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_RETURN_INV_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "C_NAME", "C_TAX_NO", "SALES_INV_ID", "STORE_DATE", "C_MOBILE_NO", "C_STREET", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "TRANS_TYPE_AR", "TRANS_TYPE_EN", "INVOICE_TYPE", "PAYMENT_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_RPT" ("C_NAME", "INV_TYPE_AR", "INV_TYPE_EN", "INVOICE_DATE", "INVOICE_NO", "POST_DIS_AMOUNT", "TOTAL_VAT", "INV_AMOUNT") AS 
  SELECT
    C_NAME,
    INV_TYPE_AR,
    INV_TYPE_EN,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "STORE_FIRST_PERIOD_STOCK_R" ("INVOICE_NO", "INV_TYPE_AR", "INV_TYPE_EN", "P_NAME", "P_TAX_NO", "P_INV_DATE", "P_INV_ID", "STORE_DATE", "P_MOBILE_NO", "P_STREET", "U_NAME", "PRE_TAX_AMOUNT", "TOTAL_DIS", "TOTAL_VAT", "POST_DIS_AMOUNT", "INV_AMOUNT", "INVOICE_DATE", "INVOICE_TIME", "INVOICE_ID", "QR_CODE", "INVOICE_TYPE") AS 
  SELECT
    INVOICE_NO,
    (
SELECT
