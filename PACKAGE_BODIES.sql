...
-- insert
    ...
    V_INVOICE_NO      NUMBER;
    BEGIN
       P_INVOICE_NO :=MAKE_NO.GET_SALES_INV_NO(P_COMPANY_ID);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SALES_PURCHASE_INV_TAPI" IS
    ...
    BEGIN
        P_INVOICE_NO := MAKE_NO.GET_PURCHASE_INV_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_INVOICE_NO := NVL(P_INVOICE_NO,MAKE_NO.GET_PURCHASE_INV_NO(P_COMPANY_ID => P_COMPANY_ID));
        UPDATE SALES_PURCHASE_INV
        SET
            BANK_ACC_ID = P_BANK_ACC_ID,
            ACC_JOURNAL_ID = P_ACC_JOURNAL_ID,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SALES_PURCHASE_ORDER_TAPI" IS
    ...
    BEGIN
        P_ORDER_NO := MAKE_NO.GET_PURCHASE_ORDER_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_ORDER_NO := NVL(P_ORDER_NO,MAKE_NO.GET_PURCHASE_ORDER_NO(P_COMPANY_ID => P_COMPANY_ID));
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SALES_PUR_RETURN_INV_TAPI" IS
    ...
    BEGIN
        P_INVOICE_NO := MAKE_NO.GET_PUR_RETURN_INV_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_INVOICE_NO := NVL(P_INVOICE_NO,MAKE_NO.GET_PUR_RETURN_INV_NO(P_COMPANY_ID => P_COMPANY_ID));
        UPDATE SALES_PUR_RETURN_INV
        SET
            BANK_ACC_ID = P_BANK_ACC_ID,
            PAID_AMOUNT = P_PAID_AMOUNT,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "SALES_RENT_INV_TAPI" IS
    ...
    BEGIN
        P_INVOICE_NO := MAKE_NO.GET_RENT_INV_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_INVOICE_NO := NVL(P_INVOICE_NO,MAKE_NO.GET_RENT_INV_NO(P_COMPANY_ID => P_COMPANY_ID));
...
-- insert
    ...
    BEGIN
       P_INVOICE_NO :=MAKE_NO.GET_SALES_RETURN_INV_NO(P_COMPANY_ID);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "STORE_FIRST_PERIOD_STOCK_TAPI" IS
    ...
    BEGIN
        P_INVOICE_NO := MAKE_NO.GET_FIRST_PERIOD_STOCK_INV_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_INVOICE_NO := NVL( P_INVOICE_NO, MAKE_NO.GET_FIRST_PERIOD_STOCK_INV_NO(P_COMPANY_ID => P_COMPANY_ID));
...
-- insert
    ...
    BEGIN
     ...
     P_ORDER_NO :=MAKE_NO.GET_STOCKIN_ORDER_NO(P_COMPANY_ID);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "STORE_STOCKOUT_ORDER_TAPI" IS
    ...
    BEGIN
        P_ORDER_NO := MAKE_NO.GET_STOCKOUT_ORDER_NO(P_COMPANY_ID => P_COMPANY_ID);
    ...
    BEGIN
        P_ORDER_NO := NVL( P_ORDER_NO, MAKE_NO.GET_STOCKOUT_ORDER_NO(P_COMPANY_ID => P_COMPANY_ID) );
        UPDATE STORE_STOCKOUT_ORDER
        SET
            NOTES = P_NOTES,
            ORDER_DATE = P_ORDER_DATE,
...
-- insert
    ...
    BEGIN
     P_TRANSFER_NO :=MAKE_NO.GET_SALES_RETURN_INV_NO(P_COMPANY_ID);
